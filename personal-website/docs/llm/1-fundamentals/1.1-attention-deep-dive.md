...
# 1.1 注意力机制深挖 (MHA / MQA / GQA / MLA / FlashAttention)
...
## 🕸️ 1. 知识网格与前置/后置依赖 (Knowledge Graph Connections)
...
## ⏳ 2. 技术演进史与驱动瓶颈 (Evolution Line & Trade-offs)
...
## 💻 3. 硬件与底层算子 (Roofline Model & Hardware Mechanics)
...
## 🧮 4. 算法推导与数学原理 (Mathematical Derivation)
...
## 💻 6. 算法与代码实战 (PyTorch Reference Implementation)
...
## 🔗 7. 扩展学习与多维资源补充 (Resources & Anchors)
